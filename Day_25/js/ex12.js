    ...
    element.addEventListener('click', function (event) {
      ...
      console.log('i: ', i);
        ...
        if (i === clickedItemIndex) {
          console.log('active dot index', i);
          dots.children[i].classList.add("dot-item--active")

          if (i >= indexDotSelected) { // Nếu index chấm lơn hơn 0 -> Next slide
            // indexDotSelected = i;
        ...
        } else if (i !== clickedItemIndex) {
          // console.log('Bỏ active các dot khác');
